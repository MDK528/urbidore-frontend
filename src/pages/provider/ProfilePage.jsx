...
import { Loader2, Save, User, MapPin, Wrench, FileText } from 'lucide-react'
import { getMyProviderProfile, updateMyProviderProfile } from '../../api/providers.api'
import {
  Select,
  SelectContent,
  SelectGroup,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await updateMyProviderProfile({
        ...form,
        yearExperience: form.yearExperience ? Number(form.yearExperience) : undefined,
      })
      setSuccess(true)
    } catch (err) {
      ...
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-zinc-900 border border-white/6 rounded-2xl p-6 space-y-5">
            ...
            <div className="space-y-2">
              <Label className="text-zinc-300 text-sm">Service Area</Label>
              <Input
                name="serviceArea"
          ...
          <div className="bg-zinc-900 border border-white/6 rounded-2xl p-6 space-y-5">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                rows={4}
                className="w-full bg-zinc-900 border border-zinc-700 text-white placeholder:text-zinc-600 rounded-xl px-3 py-3 text-sm focus:outline-none focus:border-amber-400/50 resize-none"
              />
            </div>
          </div>
